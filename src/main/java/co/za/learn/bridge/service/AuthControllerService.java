...
public interface AuthControllerService {
     ...
     ResponseEntity<Object> profileSetup(@Valid @RequestBody ProfileSetupRequest request) throws LearnBridgeException;
     ResponseEntity<Object> forgotPassword(ForgotPasswordRequest request);
}
